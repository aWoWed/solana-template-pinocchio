...
// The scaffold shells out to `pwd` here. On Windows, zx may resolve `pwd`
// through a POSIX shell that reports a mount-style path (e.g. `/mnt/d/...`),
// which then joins into nonsense like `D:\mnt\d\...`. `process.cwd()` is both
// native and shell-independent.
